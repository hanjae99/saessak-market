...
public class ProductImgService {
    ...
    public void saveProductImg(Image image, MultipartFile productImgFile)throws Exception{
        ...
        if (oriImgName != null){
            imgName = fileService.uploadFile(productImgLocation + "/images/product", oriImgName, productImgFile.getBytes());
    ...
    public void updateProductImg(Long imageId, MultipartFile productImgFile, String oriName) throws Exception{
        ...
        if (!productImgFile.isEmpty()){
            ...
            if (savedProductImg.getImgName() != null){
                fileService.deleteFile(productImgLocation + "/images/product/" + savedProductImg.getImgName());
            }

            // 이미지 바뀌어도 원래 이름은 그대로
            String oriImgName = oriName;
            String imgName = fileService.uploadFile(productImgLocation + "/images/product", oriImgName, productImgFile.getBytes());
    ...
    public void deleteProductImg(Long imageId, String imgName) throws Exception {
        ...
        fileService.deleteFile(productImgLocation + "/images/product/" + imgName);
    }
